...
class ContactBook():
    ...
    def contact_book_create(self, dbconn, details):
    ...
    def contact_book_update(self, dbconn, details):
    ...
    def contact_book_delete(self, dbconn, details):
        query_output = contact_book_search(dbconn, details)
    ...
    def contact_book_search(self, dbconn, details):
